...
def genALGO_2(size):
    size=size*2
    initial_population= population_maker_2(size)

    prnt1,prnt2=random_parent_2(initial_population)
    cld1,cld2=two_point_cross(prnt1,prnt2)

    return cld1,cld2

off1, off2= genALGO_2(int(input("Insert Population Size(int): ")))
